...
--
-- Gép: localhost
-- Létrehozás ideje: 2024. Ápr 30. 08:30
...
-- Adatbázis: `etlap`
--
CREATE DATABASE IF NOT EXISTS `etlap` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci;
USE `etlap`;
...
CREATE TABLE `etelek` (
  ...
  `leiras` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL
...
CREATE TABLE `kategoriak` (
  `katAz` int(11) NOT NULL,
  `katNev` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
